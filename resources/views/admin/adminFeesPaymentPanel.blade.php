...
<main class="container-fluid p-4">
    ...
    <div class="container-fluid">
        <div class="table-responsive">
            <div class="card-body">
                <form action="{{ route('admin.fees.payments') }}" method="GET" id="search" class="d-flex flex-column">
                    <div class="searchAll">
                        ...
                        <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <select class="form-select form-select-sm" id="degree_id" name="degree_id">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-center">
                                    ...
                                    <a href="{{ route('admin.fees.payments') }}" class="btn btn-outline-dark btn-sm">Reset All</a>
                                </div>
                            </div>
                        </div>
    ...
    <div style="display: flex; justify-content: space-between; ">
        <span>
            <h2 class="mb-4 neon-heading fs-md-3 fs-sm-5">Fees Payments <i class="bi bi-collection"></i></h2>
        </span>
    </div>
        ...
        <div class="table-wrapper">
            <table class="table table-hover table-bordered shadow-lg">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: right;">{{ ($fees->currentPage() - 1) * $fees->perPage() + $index + 1 }}</td>
                        <th> <a href="{{ route('admin.fees.print',['student_id' => $fee->student_id, 'fees_structure_id' => $fee->fees_structure_id]) }}" class="btn btn-info btn-sm">
                                <i class="fas fa-print"></i> Print
                            </a></th>
                        <th>{{$fee->fname ?? ''}}{{' '}}{{$fee->lname ?? ''}}</th>
                        <th>{{$fee->registration_no ?? '--'}}</th>
                        <th>{{$fee->fees_structure_name ?? '--'}}</th>
                        <th>{{$fee->total_amount ?? '--'}}</th>
                        <th>{{$fee->payment_date ?? '--'}}</th>
                        <th>{{$fee->reciept_number ?? '--'}}</th>
...
<script src="{{ asset('js/feesPaymentUrl.js') }}"></script>
