const initialUrl = "http://127.0.0.1:8000/adminFeesPanel";
...
function urlFilterFees(page = 1) {
    ...
    if(!search_term){
        ...
        if (min_amount && min_amount != 10000) queryString += 'min_amount=' + min_amount + '&';
        if (max_amount && max_amount != 100000) queryString += 'max_amount=' + max_amount + '&';
    }
