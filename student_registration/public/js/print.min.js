        ...
        (o.m = n =
            {
                "./src/index.js": function (e, t, n) {
                    "use strict";
                    n.r(t);
                    n("./src/sass/index.scss");
                    n = n("./src/js/init.js").default.init;
                    "undefined" != typeof window && (window.printJS = n),
                        (t.default = n);
                },
                    ...
                    t.default = {
                        print: function (r, e) {
                            r.printable.constructor !== Array &&
                                ...
                                r.header &&
                                    Object(o.addHeader)(r.printableElement, r),
                                i.default.send(r, e);
                        },
                    };
                },
                "./src/js/init.js": function (e, t, n) {
                    "use strict";
                    n.r(t);
                    var a = n("./src/js/browser.js"),
                        l = n("./src/js/modal.js"),
                        s = n("./src/js/pdf.js"),
                        d = n("./src/js/html.js"),
                        c = n("./src/js/raw-html.js"),
                        u = n("./src/js/image.js"),
                        f = n("./src/js/json.js");
                    function p(e) {
                        return (p =
                    ...
                    var b = ["pdf", "html", "image", "json", "raw-html"];
                    t.default = {
                        init: function (e, t) {
                            var n = {
                                    printable: null,
                            ...
                            switch (p(r)) {
                                case "string":
                                    (n.printable = encodeURI(r)),
                                        (n.fallbackPrintable = n.printable),
                                        (n.type = t || n.type);
                                    break;
                                case "object":
                                    for (var o in ((n.printable = r.printable),
                                    (n.fallbackPrintable =
                                        void 0 !== r.fallbackPrintable
                                            ? r.fallbackPrintable
                                            : n.printable),
                                    (n.fallbackPrintable = n.base64
                            ...
                            if (!n.printable)
                                throw new Error(
                                    "Missing printable information."
                                );
                            if (
                                !n.type ||
                                "string" != typeof n.type ||
                                -1 === b.indexOf(n.type.toLowerCase())
                            )
                                throw new Error(
                                    "Invalid print type. Available types are: pdf, html, image and json."
                                );
                            n.showModal && l.default.show(n),
                                n.onLoadingStart && n.onLoadingStart();
                            t = document.getElementById(n.frameId);
                                        ...
                                        try {
                                            console.info(
                                                ...
                                                window
                                                    ...
                                                    .focus(),
                                                n.onIncompatibleBrowser();
                                        } catch (e) {
                                            n.onError(e);
                                        } finally {
                                            n.showModal && l.default.close(),
                                                n.onLoadingEnd &&
                                                    n.onLoadingEnd();
                                        }
                                    else s.default.print(n, i);
                                    break;
                                case "image":
                                    u.default.print(n, i);
                                    break;
                    ...
                    t.default = {
                        print: function (t, e) {
                            ...
                            (t.properties = t.properties.map(function (e) {
                                return {
                                    field: "object" === o(e) ? e.field : e,
                                    displayName:
                                        "object" === o(e) ? e.displayName : e,
                                    columnSize:
                                        "object" === o(e) && e.columnSize
                                            ? e.columnSize + ";"
                                ...
                                (t.printableElement =
                                    document.createElement("div")),
                                t.header &&
                                    Object(c.addHeader)(t.printableElement, t),
                ...
                "./src/js/modal.js": function (e, t, n) {
                    ...
                    var o = {
                        show: function (e) {
                            ...
                            r.setAttribute("class", "printSpinner"),
                                n.appendChild(r);
                ...
                "./src/js/pdf.js": function (e, t, n) {
                    ...
                    function i(e, t, n) {
                        (n = new window.Blob([n], { type: "application/pdf" })),
                            (n = window.URL.createObjectURL(n));
                        t.setAttribute("src", n), r.default.send(e, t);
                    }
                    t.default = {
                        print: function (e, t) {
                            var n, r;
                            e.base64
                                ...
                                : ((e.printable = /^(blob|http|\/\/)/i.test(
                                  ...
                                  r.addEventListener("error", function () {
                                      Object(o.cleanUp)(e),
                                          e.onError(r.statusText, r);
                                  }),
                                  r.addEventListener("load", function () {
                                      return -1 === [200, 201].indexOf(r.status)
                                          ? (Object(o.cleanUp)(e),
                                            void e.onError(r.statusText, r))
                                          : void i(e, t, r.response);
                                  }),
                ...
                "./src/js/print.js": function (e, t, n) {
                    ...
                    var o = n("./src/js/browser.js"),
                        r = n("./src/js/functions.js"),
                        n = {
                            send: function (n, e) {
                                document
                                    .getElementsByTagName("body")[0]
                                    .appendChild(e);
                                var r = document.getElementById(n.frameId);
                                r.onload = function () {
                                    var e, t;
                                    "pdf" !== n.type
                                        ? ((t =
                    ...
                    function i(t, n) {
                        try {
                            if (
                                (t.focus(),
                                o.default.isEdge() || o.default.isIE())
                            )
                                try {
                ...
                "./src/js/raw-html.js": function (e, t, n) {
                    ...
                    t.default = {
                        print: function (e, t) {
                            (e.printableElement =
                                document.createElement("div")),
                                e.printableElement.setAttribute(
                                    "style",
                                    "width:100%"
                                ),
