                    ...
                    <div class="searchAll">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input value="{{ old('uid', session('uid')) }}" class="form-control form-control-sm me-2" name="uid" id="uid" type="search" placeholder="Search by UID" aria-label="Search by UID">
                            </div>
                            <div class="col">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2 mt-3 d-flex">
                                <button class="btn btn-outline-dark btn-sm w-100" type="button" onclick="validateForm()"><i class="bi bi-search"></i>Search</button>
                            </div>
