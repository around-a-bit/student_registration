...
<body>
    <main class="container-fluid p-4 d-flex align-items-center justify-content-center">
        <div class="card glassy-card w-100">
            <form action="{{ route('admin.fees.new.submit') }}" method="POST" class="form-control">
                @method('POST')
                @csrf
                <div class="card-body p-4">
                    <h5 class="card-title text-center mb-4 p-3">Add New Fees Structure</h5>
                    <div id="degree-container">
                        <div class="row mb-3 g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="academic_id" id="academic_id" class="form-select academic-select" required>

                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="specialization_id" class="form-label small text-muted">Course <span class="text-danger">*</span></label>
                                <select name="specialization_id" id="specialization_id" class="form-select specialization-select" required>

                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="semester_id" class="form-label small text-muted">Semester <span class="text-danger">*</span></label>
                                <select name="semester_id" id="semester_id" class="form-select semester-select" required>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.fees.panel') }}" class="btn btn-warning w-auto">Back <i class="bi bi-arrow-clockwise"></i></a>
                    </div>
