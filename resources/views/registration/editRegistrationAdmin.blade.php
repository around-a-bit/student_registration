...
<!-- =================================== FORM START =================================== -->
<form action="{{ route('update-student-store-admin', $student->email) }}" method="POST" enctype="multipart/form-data">
@method('PUT')
@csrf
    <!-- --------------- BASIC DETAILS TAB --------------- -->
    ...
    <div class="container mb-0 mt-5">
        <div class="row text-center">
            ...
            <div class="col-md-6 mt-2 mb-3">
                <span class="nav-link active" onclick="openTab(event, 'address')">
                    <i class="bi bi-arrow-right"></i> Next
                </span>
            </div>
        </div>
        ...
        <div id="new-course-container">
            <div class="row mb-3 degree-row">
                <div class="col">
                    ...
                    <select name="degree_id_opt" id="degree_id_opt" class="form-control" data-selected="{{ $student->degree_id_opt ?? '' }}"></select>
                </div>
                <div class="col">
                    <label for="specialization_id" class="form-label small text-muted">Specialization <span class="text-danger">*</span></label>
                    <select name="specialization_id_opt" id="specialization_id_opt" class="form-control" data-selected="{{ $student->specialization_id_opt ?? '' }}"></select>
                </div>
            </div>
        </div>
        <br>
    ...
    <div id="upload-document" class="tabcontent">
        <div id="upload-document">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label>Photo</label>
                    <input type="file" id="photo_input" value="{{ $student->photo ?? '' }}" class="form-control" >
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="file" id="signature_input" value="{{ $student->signature ?? '' }}" class="form-control" >
    ...
    function loadSpecializations(student) {
        ...
        return $.ajax({
            ...
            success: function (response) {
                ...
                if (student.specialization_id_opt) {
