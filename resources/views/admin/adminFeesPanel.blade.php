...
<main class="container-fluid p-4">
    ...
    <div class="container-fluid">
        <div class="table-responsive">
            <div class="card-body">
                <form action="{{ route('admin.fees.panel') }}" method="GET" id="search" class="d-flex flex-column">
                    <div class="searchAll">
                        ...
                        <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col text-center">
                                                <label for="total_amount" class="form-label text-center"> Amount range </label>
                                                <div id="slider" class="mb-4"></div>
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        Min: <span class="fw-bold text-success" id="min-val">{{ old('min_amount', session('min_amount', 10000)) }}</span>
                                                    </div>
                                                    <div>
                                                        Max: <span class="fw-bold text-danger" id="max-val">{{ old('max_amount', session('max_amount', 100000)) }}</span>
                                                    </div>
                                                </div>
                                                <input type="hidden" id="min_amount" name="min_amount" value="{{ old('min_amount', session('min_amount')) }}">
                                                <input type="hidden" id="max_amount" name="max_amount" value="{{ old('max_amount', session('max_amount')) }}">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-center">
                                    ...
                                    <a href="{{ route('admin.fees.panel') }}" class="btn btn-outline-dark btn-sm">Reset All</a>
                                </div>
                            </div>
                        </div>
    ...
    <div style="display: flex; justify-content: space-between; ">
        <span>
            <h2 class="mb-4 neon-heading fs-md-3 fs-sm-5">Fees Records <i class="bi bi-collection"></i></h2>
        </span>
        <span style="padding: 2rem;"><a href="{{ route('admin.fees.new')  }}" class="btn btn-success "><i class="bi bi-plus-circle"></i> Add New</a></span>
    </div>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <table class="table table-hover table-bordered shadow-lg">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.fees.edit', $structure->id) }}" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="{{ route('fees.pdf', $structure->id) }}" class="btn btn-info btn-sm">
            ...
            <div class="d-flex justify-content-center">
                {!! $feesStructures->appends(['perPage' => request('perPage')])->links('pagination::bootstrap-5') !!}
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let minAmount = document.getElementById("min_amount");
        let maxAmount = document.getElementById("max_amount");
        let minVal = document.getElementById("min-val");
        let maxVal = document.getElementById("max-val");

  
        let minInit = parseInt(minAmount.value) || 10000;
        let maxInit = parseInt(maxAmount.value) || 100000;
...
<script src="{{ asset('js/urlFees.js') }}"></script>
